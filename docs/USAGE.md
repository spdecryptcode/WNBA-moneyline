...
| Page | What it does |
|---|---|
| **Slate** | Pick slate date → match board of P(Home), margin, sigma, BET/PASS |
...
API routes live under `/api/*` (proxied by Vite in dev).

### Same as CLI `wnba-predict --date YYYY-MM-DD`

1. Slate → **Slate date** = that day  
2. Leave **Include completed** unchecked for future games  
3. Read **P(Home)** / **Margin**
